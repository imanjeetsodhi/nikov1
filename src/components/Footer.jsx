      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-col">
            ...
            <a href="https://wa.me/message/6DKPA33LE5ZZG1" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>WhatsApp</a>
            <a href="https://www.instagram.com/nikov_care?igsh=MTRuZjdvbXduY2x1cQ%3D%3D&utm_source=qr" style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Instagram</a>
            <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>info.nikovsales@gmail.com</p>
          </div>
